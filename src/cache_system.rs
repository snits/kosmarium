...
impl SimulationCache {
    ...
    pub fn has_terrain_changed_significantly(
        ...
        average_change > self.terrain_change_threshold || max_change > self.terrain_change_threshold * 10.0
    }
    ...
    fn is_cache_entry_valid(&self, entry: &TemperatureCacheEntry, current_terrain_hash: u64) -> bool {
        // Check age
...
impl CachedClimateSystem {
    ...
    pub fn get_cached_temperature_layer(&mut self, heightmap: &FlatHeightmap) -> TemperatureLayer {
        ...
        self.cache.get_temperature_layer(heightmap, season, |hm| {
            ...
            self.base_climate_system.generate_temperature_layer(&nested_heightmap)
        })
    }
    ...
    pub fn should_invalidate_cache(&self, old_heightmap: &FlatHeightmap, new_heightmap: &FlatHeightmap) -> bool {
        self.cache.has_terrain_changed_significantly(old_heightmap, new_heightmap)
    }
}
