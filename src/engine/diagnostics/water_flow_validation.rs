...
impl WaterFlowDiagnostics {
    ...
    fn validate_cfl_stability(&self, water: &WaterLayer, heightmap: &HeightMap) -> (bool, f32) {
        ...
        for y in 0..water.height() {
            for x in 0..water.width() {
                ...
                let h = water
                    .get_water_depth(x, y)
                    .max(safety_parameters::H_MIN_THRESHOLD);
    ...
    fn analyze_scale_consistency(
        ...
        let cfl_timestep_limit =
            safety_parameters::CFL_SAFETY_FACTOR * grid_spacing_m / max_wave_speed;

        // Check if parameters are appropriate for this scale
        let scale_appropriate = domain_size_km >= 1.0
            && domain_size_km <= 40_000.0
            && grid_spacing_m >= 10.0
    ...
    pub fn generate_diagnostic_report(&self, validation: &WaterFlowValidation) -> String {
        format!(
            ...
            validation
                .velocity_statistics
                .velocity_magnitude_percentiles[2], // median
...
mod tests {
    ...
    fn test_velocity_statistics() {
        ...
        assert_eq!(
            validation
                .velocity_statistics
                .velocity_magnitude_percentiles
                .len(),
            5
        );
    }
