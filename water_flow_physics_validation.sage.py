...
# This file was *autogenerated* from the file water_flow_physics_validation.sage
from sage.all_cmdline import *   # import sage library

_sage_const_9p81 = RealNumber('9.81'); _sage_const_1000 = Integer(1000); _sage_const_50 = Integer(50); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1en6 = RealNumber('1e-6'); _sage_const_0p3 = RealNumber('0.3'); _sage_const_80 = Integer(80)
...
total_mass_change = integrate(diff(h, t), (x, _sage_const_0 , L))
total_inflow = integrate(rain_rate, (x, _sage_const_0 , L))
total_evaporation = integrate(evap_rate * h, (x, _sage_const_0 , L))
...
current_cfl = dt <= dx / sqrt(u**_sage_const_2  + v**_sage_const_2 )
...
rainfall_scaling = rain_rate / scale_factor**_sage_const_2 
...
h_min_threshold = _sage_const_1en6   # meters - similar to F_THRESHOLD approach
...
cfl_safety_factor = _sage_const_0p3   # Conservative, similar to atmospheric physics
