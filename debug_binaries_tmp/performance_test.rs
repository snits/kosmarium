...
use sim_prototype::drainage::{FlowDirectionMap, FlowAccumulationMap};
...
fn benchmark_flow_accumulation(width: usize, height: usize) -> u128 {
    ...
    println!("Testing {}x{} map ({} cells)...", width, height, width * height);
...
fn main() {
    ...
    println!("{:>8} {:>10} {:>12} {:>15}", "Cells", "Time (ms)", "ms/cell", "Scale Factor");
    println!("{:-<8} {:-<10} {:-<12} {:-<15}", "", "", "", "");
